...
**This release (`0.0.1`) is a name reservation on PyPI, not a working library.** It has no functionality beyond a version number. A design is in progress; see [project/ROADMAP.md](project/ROADMAP.md) for status.
